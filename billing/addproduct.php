...
<a href="../billing/user.php" class="active"> <i class="fa fa-shopping-cart "></i> Product List </a>
</div>
<!--report-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" role="form" action="../backend/addproduct.php" id="addProduct">
                            <div>
                                <a class="btn bg-warning" href="../billing/product.php"> <i class="fa fa-close"></i> Close</a>
                                <button type="submit" name="addProduct" class="btn bg-primary"><i class="fa fa-save"></i> Save</button>
                            </div>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-10">
                                                <input type="number" id="price" class="form-control" name="price" min="0" value="0" required>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<script src="../plugins/add.product.js"></script>
</body>
</html>
