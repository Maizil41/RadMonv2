...
include ("../include/billing.product.php");
?>
...
<div class="card-header">
	<h3><i class=" fa fa-shopping-cart"></i> Product List &nbsp; | &nbsp; <a href="../billing/addproduct.php" title="Add User"><i class="fa fa-cart-plus"></i> Add</a></h3>
</div>
<div class="card-body">
<div class="row">
<div class="row">
...
<tr>
  <th><center><?php echo "$total_product"; ?> items</th>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td><center>
            <a href='./editproduct.php?id=$id' class='fa fa-edit pointer' title='Edit'></a>&nbsp;&nbsp;
            <i class='fa fa-trash text-danger pointer' title='Hapus'
                onclick=\"confirmDelete('$id', '$name')\"></i>
            </center></td>";
...
<script src="../plugins/product.list.js"></script>
</body>
</html>