...
<a href="../billing/product.php" class="active"><i class="fa fa-shopping-cart"></i> Product List </a>
</div>
<!--report-->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fa fa-pencil"></i> Edit Product : <?php echo htmlspecialchars($uid['name']); ?></h3>
                    </div>
                    <div class="card-body">
                        <form method="post" role="form" action="../backend/update_product.php">
                            <div>
                                <input type="hidden" id="uid" name="uid" value="<?php echo htmlspecialchars($_GET['id']); ?>">
                                <a class="btn bg-warning" href="../billing/product.php"> <i class="fa fa-close"></i> Close</a>
                                <button type="submit" name="updateproduct" class="btn bg-primary"><i class="fa fa-save"></i> Save</button>
                            </div>
                            ...
                            <table class="table">
                                <tr>
                                    <td>Product Name</td>
                                    <td>
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($uid['name']); ?>" required>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-10">
                                                <input type="number" id="price" class="form-control" name="price" min="0" value="<?php echo htmlspecialchars($uid['price']); ?>" required>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Stock</td>
                                    <td>
                                        <input type="number" class="form-control" id="amount" name="amount" min="1" value="<?php echo htmlspecialchars($uid['amount']); ?>" required>
                                    </td>
                                </tr>
                            </table>
                        </form>
